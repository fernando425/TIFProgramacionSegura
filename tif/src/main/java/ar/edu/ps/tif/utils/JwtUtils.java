...
public class JwtUtils {
    ...
    public String createToken(Authentication authentication) {
        ...
        String jwtToken = JWT.create()
                ...
                .withExpiresAt(new Date(System.currentTimeMillis() + 1800000)) // fecha de expiración, tiempo en
                                                                               // milisegundos
                .withJWTId(UUID.randomUUID().toString()) // id al token - que genere una random
                .withNotBefore(new Date(System.currentTimeMillis())) // desde cuando es válido (desde ahora en este
                                                                     // caso)
